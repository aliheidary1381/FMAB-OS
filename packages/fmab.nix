...
pkgs.runCommand "fmab-customizations" { } ''
  ...
  }/share/color-schemes/CatppuccinLatteYellow.colors" "$out/share/color-schemes/CatppuccinLatteYellow.colors"
  install -Dm644 "${
    pkgs.catppuccin-kde.override {
      flavour = [ "frappe" ];
      accents = [ "yellow" ];
    }
  }/share/color-schemes/CatppuccinFrappeYellow.colors" "$out/share/color-schemes/CatppuccinFrappeYellow.colors"
''
